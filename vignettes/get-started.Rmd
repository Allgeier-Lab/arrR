...
# create fishpop
input_fishpop <- setup_fishpop(seafloor = input_seafloor, species = rep(2, starting_values$pop_n),#2, 2, 1, 2, 1, 1, 2, 2), 
...
result <- run_simulation(seafloor = input_seafloor, fishpop = input_fishpop, burn_in = 8000, 
                         parameters = parameters, movement = "behav",
                         max_i = max_i, min_per_i = min_per_i, 
                         nutrients_input = rep(0, max_i),#stable_values$input_nutr, max_i),
