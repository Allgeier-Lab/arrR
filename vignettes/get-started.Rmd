...
parameters$pop_a[2] <- 0.2
parameters$pop_b[2] <- 3.5
parameters$pop_k[2] <- 0.3
parameters$pop_linf[2] <- 44
parameters$pop_n_body[2] <- 0.05
parameters$resp_intercept[2] <- 0.11
parameters$resp_slope[2] <- -0.22
