...
To see a full list all needed starting values and parameters, simply run `check_parameters()`. Both starting values and parameters must be provided as a named lists. The package contains a set of default values you can easily access (`arrR_parameters`, `arrR_starting_values`).
