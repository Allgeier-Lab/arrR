...
void rcpp_simulate(Rcpp::NumericMatrix seafloor, Rcpp::NumericMatrix fishpop, Rcpp::NumericVector nutrients_input,
                   Rcpp::List seafloor_track, Rcpp::List fishpop_track, Rcpp::List parameters, Rcpp::NumericMatrix fishpop_attr,
                   std::string movement, Rcpp::NumericVector extent, Rcpp::IntegerVector dimensions,
