...
// rcpp_move_fishpop
void rcpp_move_fishpop(Rcpp::NumericMatrix fishpop, Rcpp::NumericVector reef_dist, Rcpp::NumericVector pop_thres_reserves, double move_mean, double move_reef, double move_return, double pop_visibility, Rcpp::NumericVector extent, Rcpp::NumericVector dimensions);
RcppExport SEXP _arrR_rcpp_move_fishpop(SEXP fishpopSEXP, SEXP reef_distSEXP, SEXP pop_thres_reservesSEXP, SEXP move_meanSEXP, SEXP move_reefSEXP, SEXP move_returnSEXP, SEXP pop_visibilitySEXP, SEXP extentSEXP, SEXP dimensionsSEXP) {
BEGIN_RCPP
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< Rcpp::NumericMatrix >::type fishpop(fishpopSEXP);
    ...
    Rcpp::traits::input_parameter< Rcpp::NumericVector >::type extent(extentSEXP);
    Rcpp::traits::input_parameter< Rcpp::NumericVector >::type dimensions(dimensionsSEXP);
    rcpp_move_fishpop(fishpop, reef_dist, pop_thres_reserves, move_mean, move_reef, move_return, pop_visibility, extent, dimensions);
    return R_NilValue;
END_RCPP
}
// rcpp_rlognorm
